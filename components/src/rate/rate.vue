<template>
  <div class="n-rate">
    <div class="n-rate-list" @mouseout="width = modelValue">
      <Icon v-for="(num, index) in 5" :size="sizeChange(iconSize)" :key="num" :name="iconName"
        :color="width > index ? effectColor : invalidColor" class="n-rete-icon" @click="upDataValue"
        @mouseover="width = num" />
    </div>
